 ...
 */
final class Version20200723190354 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE property_message (property_id INT NOT NULL, message_id INT NOT NULL, INDEX IDX_EF707A07537A1329 (message_id), INDEX IDX_EF707A07549213EC (property_id), PRIMARY KEY(property_id, message_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
